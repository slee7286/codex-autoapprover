...
The Windows preflight deliberately observed no real `PermissionRequest` and returned no structured allow to real Codex. It did not modify persistent Codex configuration or promote Windows 0.152.1.
